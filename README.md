...
### On a DICE machine
On DICE, we will clone the [Lecture code repository](https://github.com/ediadvancedrobotics/lecturecode) and install the required [dependencies](https://github.com/ediadvancedrobotics/lecturecode/blob/main/requirements.txt) to run the tutorials. 
